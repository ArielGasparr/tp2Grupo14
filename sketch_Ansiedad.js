// ============================================
//  SKETCH INDIVIDUAL — ESCENA: ANSIEDAD
...
function drawHUD() {
  ...
  textAlign(CENTER);
  textSize(7.5);
  text('mover el cursor hacia el centro para intensificar', width / 2, height - 28);
...
function mouseMoved() {
  posMouseX = mouseX;
  posMouseY = mouseY;
  S_Ansiedad.alMover(posMouseX, posMouseY);
}
...
function mousePressed() {
  S_Ansiedad.alClick(mouseX, mouseY);
}
...
function touchStarted() {
  ...
  S_Ansiedad.alClick(posMouseX, posMouseY);
  return false;
}
