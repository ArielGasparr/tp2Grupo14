// ============================================
//  SKETCH INDIVIDUAL — ESCENA: INCERTIDUMBRE
...
function draw() {
  ...
  // escena activa
  S_Incertidumbre.actualizar();
  S_Incertidumbre.dibujar();
...
function mouseMoved() {
  posMouseX = mouseX;
  posMouseY = mouseY;
  S_Incertidumbre.alMover(posMouseX, posMouseY);
}
...
function mousePressed() {
  S_Incertidumbre.alClick(mouseX, mouseY);
}
...
function touchStarted() {
  ...
  S_Incertidumbre.alClick(posMouseX, posMouseY);
  return false;
}
